...
> **Note:** `--flip_registration` is a workaround for machines that require a rotated cutting template. A more permanent solution is planned; see the related GitHub issue for details.
