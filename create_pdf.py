...
@click.option("--template_type", default=TemplateType.STANDARD.value, type=click.Choice([t.value for t in TemplateType], case_sensitive=False), show_default=True, help="The desired path to the output PDF.")
