...
@click.option("--back_dir_path", default=back_directory, show_default=True, help="The path to the directory containing one or no card back image.")
@click.option("--double_sided_dir_path", default=double_sided_directory, show_default=True, help="The path to the directory containing card back images for double-sided cards.")
...
def cli(front_dir_path, back_dir_path, double_sided_dir_path, output_pdf_path, template_type, front_registration):
    generate_pdf(front_dir_path, back_dir_path, double_sided_dir_path, output_pdf_path, template_type, front_registration)
