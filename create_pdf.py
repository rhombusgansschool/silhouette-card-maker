...
@click.option("--quality", default=75, type=click.IntRange(min=0, max=100), show_default=True, help="Image quality. A higher value corresponds to better image quality and larger file size.")
...
def cli(front_dir_path, back_dir_path, double_sided_dir_path, output_pdf_path, card_size, paper_size, front_registration, only_fronts, crop, extend_corners, quality, load_offset, name):
    generate_pdf(front_dir_path, back_dir_path, double_sided_dir_path, output_pdf_path, card_size, paper_size, front_registration, only_fronts, crop, extend_corners, quality, load_offset, name)
