...
@click.option("--back_dir_path", default=back_directory, show_default=True, help="The path to the directory containing one or none back image.")
...
def cli(front_dir_path, back_dir_path, pdf_path, template_type, front_registration):
    generate_pdf(front_dir_path, back_dir_path, pdf_path, template_type, front_registration)
