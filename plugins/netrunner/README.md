...
This plugin reads a decklist from [NetrunnerDB](https://netrunnerdb.com/) and puts the card images from [NRO Proxy](https://proxy.nro.run/) into the proper `game/` directories.
